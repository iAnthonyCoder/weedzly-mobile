...
import Map from './pages/map/indexs';
	...
	const reverseGeoFetch = (long: any, lat: any) => {
        return mapboxService.reverseGeocoding(long, lat, 'types=address%2Cplace%2Cregion%2Cpostcode')
            .then(async res => {
                ...
                await localStorage.setItem(BACKGROUND_STATE, stateInfo.background)
                ...
                if(myLocationPlace.stateId){
                    ...
                    await localStorage.setItem(BACKGROUND_STATE, state.background)
  	...
  	return (
			...
			/>
				...
				<IonRouterOutlet id="main">
					...
					<Route path={`/brands/:brand_slug/products/:product_slug`} component={BrandProduct} />
