...
import { alertCircleOutline, callOutline, card, carOutline, checkmarkDone, closeCircleOutline, cubeOutline, hourglassOutline, idCard, locationOutline, reloadOutline, timerOutline } from 'ionicons/icons'
...
const OrderNoAccount = (props) => {
    ...
    const getData = async () => {
        ...
        try {
            ...
            let res = await orderService.getGuest(props.match.params._id, token)
            setData(res)
